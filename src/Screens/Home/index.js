...
// import { View, Text, ScrollView, Platform, ImageBackground, Alert, RefreshControl } from 'react-native';
// import { useNavigation, useFocusEffect } from '@react-navigation/native';
// import Colors from '../../Themes/Colors';
// import { responsiveHeight, responsiveWidth } from 'react-native-responsive-dimensions';
// import { InsuranceCard, LearnmoreCard, MutualFundCard, ReferImg, SIPImg, CompleteKycCard, InvesTekLogo } from '../../Assets/svg';
...
//     try {
//       await Promise.all([fetchDashboardPortfolio(), fetchDetailsCompleted(), fetchMfStatus(), fetchClientDetails()]);
//     } catch (error) {
...
//           <Text allowFontScaling={false} style={styles.viewAll} onPress={handleNext}>View All</Text>
//         </View>
...
//     return (
//       <View>
//         <Text allowFontScaling={false} style={styles.heading}>Services</Text>
//         <View style={styles.row}>
//           <ServiceBox
//             title="Mutual Fund"
//             SvgIcon={MutualFundCard}
//             borderColor={Colors.yellow}
//             width={responsiveWidth(26)}
//             marginHorizontal={responsiveWidth(0.2)}
//             onPress={handleNext} />
//           <ServiceBox title="Insurance"
//             SvgIcon={InsuranceCard}
...
//         <PromoCard
//           RightSideSvgImage={ReferImg}
//           title="Refer & Get Reward"
//           subtitle="Get rewards up to 20% of first payment."
//           borderColor={Colors.borderRed}
...
//         refreshControl={
//           <RefreshControl refreshing={isRefreshing} onRefresh={fetchAllData} />
//         }
//       >
//         {portfolioData && (
//           <>
