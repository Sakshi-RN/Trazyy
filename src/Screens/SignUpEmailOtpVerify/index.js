...
const SignUpEmailOtpVerify = ({ route }) => {
        ...
        >
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={styles.container}>
                    ...
                    <Text allowFontScaling={false} style={styles.welcomeText}>Email Verify OTP</Text>
...
export default SignUpEmailOtpVerify;
